...
class ElectraForSequenceClassification(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        if ours:
            loss, logits, outputs = self.electra_ours(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
            ...
            loss, logits, outputs = self.electra_kl(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                                                    labels, output_attentions, output_hidden_states, return_dict)
        else:
            loss, logits, outputs = self.electra_cross_entropy(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                                                               labels, output_attentions, output_hidden_states, return_dict)
    ...
    def electra_ours(self, input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                   labels, output_attentions, output_hidden_states, return_dict):
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
        ...
        outputs = discriminator_hidden_states[0]
    ...
    def electra_cross_entropy(self, input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                            labels, output_attentions, output_hidden_states, return_dict):
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
    ...
    def electra_kl(self, input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds,
                 labels, output_attentions, output_hidden_states, return_dict):
        outputs_list = []
        logits_list = []
        ...
        if self.config.adv_eps > 0:
            ...
            discriminator_hidden_states = self.electra.encoder(
                noised_embeddings,
                attention_mask=extended_attention_mask,
                head_mask=head_mask,
                output_attentions=output_attentions,
            ...
            outputs = discriminator_hidden_states[0]
            bef_logits = self.classifier(outputs)
