...
class DebertaForSequenceClassification(DebertaPreTrainedModel):
    ...
    def forward(
        ...
        if ours:
            loss, logits, outputs = self.deberta_ours(input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
            ...
            loss, logits, outputs = self.deberta_kl(input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
                                    labels, output_attentions, output_hidden_states, return_dict)
        else:
            loss, logits, outputs = self.deberta_cross_entropy(input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
                                    labels, output_attentions, output_hidden_states, return_dict)
    ...
    def deberta_ours(self, input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
                             labels, output_attentions, output_hidden_states, return_dict):
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
        ...
        outputs = self.pooler(encoder_layer)
    ...
    def deberta_cross_entropy(self, input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
                             labels, output_attentions, output_hidden_states, return_dict):
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
    ...
    def deberta_kl(self, input_ids, attention_mask, token_type_ids, position_ids, inputs_embeds,
        ...
        embedding_output = self.deberta.embeddings(input_ids=input_ids, position_ids=position_ids,
        ...
        if self.config.adv_eps > 0:
            ...
            encoder_outputs = self.deberta.encoder(
                noised_embeddings,
                attention_mask,
                output_hidden_states=True,
                output_attentions=output_attentions,
            ...
            encoder_layer = encoded_layers[-1]
